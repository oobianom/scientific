...
output:
  scientific::tufte_html: 
    toc: true
  scientific::tufte_handout:
    citation_package: natbib
    latex_engine: xelatex
  scientific::tufte_book:
    citation_package: natbib
    latex_engine: xelatex
...
knitr::opts_chunk$set(cache.extra = packageVersion('scientific'))
...
author: "John Smith"
output:
  scientific::tufte_handout: default
  scientific::tufte_html: default
---
```
